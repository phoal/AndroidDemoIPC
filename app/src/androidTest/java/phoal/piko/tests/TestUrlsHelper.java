...
import phoal.piko.view.DisplayImagesActivity;
import phoal.piko.view.DownloadActivity;
...
public class TestUrlsHelper {
    ...
    public static void doTest(
        ...
        Assert.assertTrue(
                ...
                solo.waitForActivity(DownloadActivity.class));

        // Click on url text view.
        solo.clickOnView(solo.getView(phoal.piko.R.id.url));
        ...
        for (int i = 0; i < count; i++) {
            ...
            solo.clickOnView(solo.getView(phoal.piko.R.id.button2));
        ...
        LinearLayout linearLayout = (LinearLayout)
                solo.getView(phoal.piko.R.id.linearLayout);
        ...
        solo.clickOnView(solo.getView(phoal.piko.R.id.downloadFabButton));
        ...
        if (validCount == 0) {
            ...
            GridView view = (GridView)
                    solo.getView(phoal.piko.R.id.imageGrid);
        ...
        if (validCount > 0) {
            ...
            solo.clickOnView(solo.getView(phoal.piko.R.id.clearFabButton));
