...
public class WeatherUtils {
     ...
     * @param temperature from OpenWeatherMap API response
     * @param isFarhenheit
     ...
     *
     * @param context Context
     * @param windSpeedStr Speed from OpenWeatherMap API response
     * @param windDirStr Direction from OpenWeatherMap API response
