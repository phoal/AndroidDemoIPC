...
public class DownloadImagesBoundService 
	...
	private static class RequestHandler extends Handler {
		...
		public void handleMessage(Message message) {
			...
			// stored.
			// TODO -- you fill in here.
			final Uri dir = requestMessage.getDirectoryPathname();
			...
			// Retrieve unique file identifier
			final String fileId = requestMessage.getFileId();
			...
			final Runnable downloadImageAndReply =
					new Runnable() {
						...
						public void run() {
							...
							// TODO -- you fill in here.
							// Context never used in downloadImage() method - can use null (or
							// mService.get().getApplicationContext() in case of any code changes!)
							// The ApplicationContext is the preferred use of context for a service.
							final Uri image = Utils.downloadFile(url, dir, fileId);

							// Send the path to the image file, url, and
							// requestCode back to the Activity via the
							// replyMessenger.
							// TODO -- you fill in here.
							sendPath(replyMessenger, image, url, reqCode);
    ...
    public void onDestroy() {
        ...
        // (Reclaims all resources held by the ExecutorService)
    	// TODO -- you fill in here.
