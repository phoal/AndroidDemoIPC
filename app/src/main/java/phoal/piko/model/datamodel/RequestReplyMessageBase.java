package phoal.piko.model.datamodel;
...
public class RequestReplyMessageBase {
   /**
    ...
    /**
     * String constant used as unique file identifier
     */
    ...
    /**
     * Accessor method that returns the unique file identifier
     */
    public String getFileId() {
        return mMessage.getData().getString(FILE_ID);
    }

    /**
     * Accessor method that sets the unique file identifier
     */
    public void setFileId(String fileId) {
        mMessage.getData().putString(FILE_ID, fileId);
    }
    /**
     ...
     */
    public void setImageUri(Uri imagePathname) {
